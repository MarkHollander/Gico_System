...
{
    public class CustomerChangeRequestValidator : AbstractValidator<CustomerAddOrChangeRequest>
    {
        public CustomerChangeRequestValidator()
        {
        ...
        {
            FluentValidation.Results.ValidationResult validationResult = new CustomerChangeRequestValidator().Validate(request);

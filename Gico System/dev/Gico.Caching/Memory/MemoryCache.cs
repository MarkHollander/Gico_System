...
using Gico.Caching.Abstractions.Internal;
using Gico.Caching.Memory;
using Microsoft.Extensions.Options;

namespace GaBon.Caching.Memory
{
    /// <inheritdoc />
    /// <summary>
    /// An implementation of <see cref="T:GaBon.Caching.Abstractions.IMemoryCache" /> using a dictionary to
    /// store its entries.
    /// </summary>

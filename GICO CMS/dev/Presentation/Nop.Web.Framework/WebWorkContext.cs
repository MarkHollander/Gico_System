    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        public virtual Vendor CurrentVendor
        {
            get
            {
                ...
                //if (vendor == null || vendor.VendorStatus == (int)Vendor.StatusEnum.Deleted || !vendor.IsActive)
                //    return null;
        ...
        public virtual Language WorkingLanguage
        {
            get
            {
                    ...
                    if (!alreadyDetected)
                    {
                        ...
                        if (detectedLanguage != null)
                        {
                            ...
                            _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                                SystemCustomerAttributeNames.LanguageAutomaticallyDetected, true, 0);
                        }
                    }
                }
                ...
                if (detectedLanguage != null)
                {
                    ...
                    {
                        _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                            SystemCustomerAttributeNames.LanguageId, detectedLanguage.Id, 0);
                    }
                }
                ...
                var allStoreLanguages = _languageService.GetAllLanguages(storeId: 0);
            ...
            set
            {
                ...
                //and save it
                _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                    SystemCustomerAttributeNames.LanguageId, languageId, 0);
        ...
        public virtual Currency WorkingCurrency
        {
            get
            {
                ...
                var allStoreCurrencies = _currencyService.GetAllCurrencies(storeId: 0);
            ...
            set
            {
                ...
                //and save it
                _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                    SystemCustomerAttributeNames.CurrencyId, currencyId, 0);
        ...
        public virtual TaxDisplayType TaxDisplayType
        {
            ...
            set
            {
                ...
                //save passed value
                _genericAttributeService.SaveAttribute(this.CurrentCustomer,
                    SystemCustomerAttributeNames.TaxDisplayTypeId, (int)value, 0);

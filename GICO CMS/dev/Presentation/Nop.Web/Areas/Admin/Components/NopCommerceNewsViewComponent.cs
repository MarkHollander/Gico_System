...
namespace Nop.Web.Areas.Admin.Components
{
    public class NopCommerceNewsViewComponent : NopViewComponent
    {
        ...
        public NopCommerceNewsViewComponent(
        ...
        public IViewComponentResult Invoke()
        {
            try
            {
                var feedUrl = $"http://www.nopCommerce.com/NewsRSS.aspx?Version={NopVersion.CurrentVersion}&Localhost={_webHelper.IsLocalRequest(Request)}&HideAdvertisements={_adminAreaSettings.HideAdvertisementsOnAdminArea}"
                        .ToLowerInvariant();

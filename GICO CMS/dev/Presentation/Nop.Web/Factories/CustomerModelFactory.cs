    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
            ...
            bool excludeProperties, string overrideCustomCustomerAttributesXml = "")
        {
            ...
            if (!excludeProperties)
            {
                ...
                //newsletter
                var newsletter = _newsLetterSubscriptionService.GetNewsLetterSubscriptionByEmailAndStoreId(customer.Email, 0);
            ...
            model.NumberOfExternalAuthenticationProviders = _externalAuthenticationService
                .LoadActiveExternalAuthenticationMethods(_workContext.CurrentCustomer, 0).Count;
        ...
        public virtual CustomerNavigationModel PrepareCustomerNavigationModel(int selectedTabId = 0)
        {
            ...
            if (_orderSettings.ReturnRequestsEnabled &&
                _returnRequestService.SearchReturnRequests(0,
                    _workContext.CurrentCustomer.CustomerId, pageIndex: 0, pageSize: 1).Any())
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
        ...
        public virtual CustomerDownloadableProductsModel PrepareCustomerDownloadableProductsModel()
        {
            ...
            var items = _orderService.GetDownloadableOrderItems(_workContext.CurrentCustomer.CustomerId);

...
//                var pickupPointProviders = _shippingService.LoadActivePickupPointProviders(_workContext.CurrentCustomer, 0);
//                if (pickupPointProviders.Any())
//                {
//                    var languageId = _workContext.WorkingLanguage.Id;
//                    var pickupPointsResponse = _shippingService.GetPickupPoints(_workContext.CurrentCustomer.BillingAddress,
//                        _workContext.CurrentCustomer, storeId: 0);
...
//                if (!_shippingService.LoadActiveShippingRateComputationMethods(_workContext.CurrentCustomer, 0).Any())
//                {
//                    if (!pickupPointProviders.Any())
//                    {
...
//            var getShippingOptionResponse = _shippingService.GetShippingOptions(cart, shippingAddress, _workContext.CurrentCustomer, storeId: 0);
...
//                        SystemCustomerAttributeNames.SelectedShippingOption, 0);
...
//            {
//                var rewardPointsBalance = _rewardPointService.GetRewardPointsBalance(_workContext.CurrentCustomer.Id, 0);
...
//                .LoadActivePaymentMethods(_workContext.CurrentCustomer, 0, filterByCountryId)

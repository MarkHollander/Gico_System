...
namespace Nop.Web.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        protected virtual int GetUnreadPrivateMessages()
        {
            ...
            {
                var privateMessages = _forumservice.GetAllPrivateMessages(0,
                    string.Empty, customer.CustomerId, false, null, false, string.Empty, 0, 1);
        ...
        public virtual LogoModel PrepareLogoModel()
        {
            ...
            var cacheKey = string.Format(ModelCacheEventConsumer.STORE_LOGO_PATH, 0, _themeContext.WorkingThemeName, _webHelper.IsCurrentConnectionSecured());
        ...
        {
            var availableCurrencies = _cacheManager.Get(string.Format(ModelCacheEventConsumer.AVAILABLE_CURRENCIES_MODEL_KEY, _workContext.WorkingLanguage.Id, 0), () =>
            {
                var result = _currencyService
                    .GetAllCurrencies(storeId: 0)
                    .Select(x =>
                    {
                        //currency char
                        var currencySymbol = "";
        ...
        public virtual ContactVendorModel PrepareContactVendorModel(ContactVendorModel model, Vendor vendor, bool excludeProperties)
        {
            ...
            model.VendorName = vendor.GetLocalized(x => x.VendorName);
        ...
        public virtual SitemapModel PrepareSitemapModel()
        {
            ...
            var cachedModel = _cacheManager.Get(cacheKey, () =>
            {
                ...
                {
                    var categories = _categoryService.GetAllCategories(storeId: 0);
                ...
                if (_commonSettings.SitemapIncludeProducts)
                {
                    ...
                    var products = _productService.SearchProducts(storeId: 0,
                ...
                //topics
                var topics = _topicService.GetAllTopics(0)
        ...
        public virtual string PrepareRobotsTextFile()
        {
            ...
            else
            {
                ...
                if (_localizationSettings.SeoFriendlyUrlsForLanguagesEnabled)
                {
                    ...
                    foreach (var language in _languageService.GetAllLanguages(storeId: 0))
                    {

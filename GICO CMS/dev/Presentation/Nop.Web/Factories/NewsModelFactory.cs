...
namespace Nop.Web.Factories
{
    ...
    public partial class NewsModelFactory : INewsModelFactory
    {
        ...
        public virtual NewsItemModel PrepareNewsItemModel(NewsItemModel model, NewsItem newsItem, bool prepareComments)
        {
            ...
            var storeId = _newsSettings.ShowNewsCommentsPerStore ? 0 : 0;
            ...
            if (prepareComments)
            {
                ...
                if (_newsSettings.ShowNewsCommentsPerStore)
                    newsComments = newsComments.Where(comment => comment.StoreId == 0);
        ...
        {
            var cacheKey = string.Format(ModelCacheEventConsumer.HOMEPAGE_NEWSMODEL_KEY, _workContext.WorkingLanguage.Id, 0);
            var cachedModel = _cacheManager.Get(cacheKey, () =>
            {
                var newsItems = _newsService.GetAllNews(_workContext.WorkingLanguage.Id, 0, 0, _newsSettings.MainPageNewsCount);
        ...
        public virtual NewsItemListModel PrepareNewsItemListModel(NewsPagingFilteringModel command)
        {
            ...
            var newsItems = _newsService.GetAllNews(_workContext.WorkingLanguage.Id, 0,

...
namespace Nop.Web.Factories
{
    ...
    public partial class PollModelFactory : IPollModelFactory
    {
        ...
        public virtual PollModel PreparePollModel(Poll poll, bool setAlreadyVotedProperty)
        {
            ...
            {
                Id = poll.Id,
                AlreadyVoted = setAlreadyVotedProperty && _pollService.AlreadyVoted(poll.Id, _workContext.CurrentCustomer.CustomerId),
                Name = poll.Name
            };
        ...
        public virtual PollModel PreparePollModelBySystemName(string systemKeyword)
        {
            ...
            model.AlreadyVoted = _pollService.AlreadyVoted(model.Id, _workContext.CurrentCustomer.CustomerId);
        ...
        public virtual List<PollModel> PrepareHomePagePollModels()
        {
            ...
            foreach (var p in cachedModel)
            {
                ...
                pollModel.AlreadyVoted = _pollService.AlreadyVoted(pollModel.Id, _workContext.CurrentCustomer.CustomerId);
                model.Add(pollModel);
            }

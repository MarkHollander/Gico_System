    ...
    public partial class ProfileModelFactory : IProfileModelFactory
    {
        ...
        public virtual ProfileInfoModel PrepareProfileInfoModel(Customer customer)
        {
            ...
            if (_customerSettings.ShowCustomersJoinDate)
            {
                ...
                joinDate = _dateTimeHelper.ConvertToUserTime(customer.CreatedDateUtc, DateTimeKind.Utc).ToString("f");
            }
        ...
        public virtual ProfilePostsModel PrepareProfilePostsModel(Customer customer, int page)
        {
            ...
            var list = _forumService.GetAllPosts(0, customer.CustomerId, string.Empty, false, page, pageSize);
            ...
            var pagerModel = new PagerModel
            {
                ...
                UseRouteLinks = true,
                RouteValues = new RouteValues { pageNumber = page, id = customer.CustomerId }
            };

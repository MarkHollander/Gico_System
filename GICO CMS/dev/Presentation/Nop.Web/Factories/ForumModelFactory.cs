    ...
    public partial class ForumModelFactory : IForumModelFactory
    {
        ...
        public virtual ForumPageModel PrepareForumPageModel(Forum forum, int page)
        {
            ...
            if (_forumService.IsCustomerAllowedToSubscribe(_workContext.CurrentCustomer))
            {
                ...
                var forumSubscription = _forumService.GetAllSubscriptions(_workContext.CurrentCustomer.CustomerId, forum.Id, 0, 0, 1).FirstOrDefault();
            ...
            var topics = _forumService.GetAllTopics(forum.Id, "", string.Empty, ForumSearchType.All, 0, (page - 1), pageSize);
            model.TopicPageSize = topics.PageSize;
            model.TopicTotalRecords = topics.TotalCount;
            model.TopicPageIndex = topics.PageIndex;
            foreach (var topic in topics)
        ...
        public virtual ForumTopicPageModel PrepareForumTopicPageModel(ForumTopic forumTopic, int page)
        {
            ...
            if (model.IsCustomerAllowedToSubscribe)
            {
                ...
                var forumTopicSubscription = _forumService.GetAllSubscriptions(_workContext.CurrentCustomer.CustomerId, 0, forumTopic.Id, 0, 1).FirstOrDefault();
            ...
            foreach (var post in posts)
            {
                var forumPostModel = new ForumPostModel
                {
                    ...
                    CustomerJoinDate = post.Customer.CreatedDateUtc,
                };
                //created on string
        ...
        public virtual void PrepareTopicEditModel(ForumTopic forumTopic, EditForumTopicModel model, bool excludeProperties)
        {
            ...
            if (!excludeProperties)
            {
                ...
                if (model.IsCustomerAllowedToSubscribe)
                {
                    var forumSubscription = _forumService.GetAllSubscriptions(_workContext.CurrentCustomer.CustomerId, 0, forumTopic.Id, 0, 1).FirstOrDefault();
        ...
        public virtual EditForumPostModel PreparePostCreateModel(ForumTopic forumTopic, int? quote, bool excludeProperties)
        {
            ...
            if (!excludeProperties)
            {
                ...
                if (model.IsCustomerAllowedToSubscribe)
                {
                    var forumSubscription = _forumService.GetAllSubscriptions(_workContext.CurrentCustomer.CustomerId,
        ...
        public virtual CustomerForumSubscriptionsModel PrepareCustomerForumSubscriptionsModel(int? page)
        {
            ...
            var list = _forumService.GetAllSubscriptions(customer.CustomerId, 0, 0, pageIndex, pageSize);

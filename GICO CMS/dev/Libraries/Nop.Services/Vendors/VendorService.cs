...
namespace Nop.Services.Vendors
{
    ...
    public partial class VendorService : IVendorService
    {
        ...
        public virtual void DeleteVendor(Vendor vendor)
        {
            ...
            vendor.VendorStatus = (int)Vendor.StatusEnum.Deleted;
            UpdateVendor(vendor);
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            ...
            if (!showHidden)
                query = query.Where(v => v.VendorStatus== (int)Vendor.StatusEnum.Active);
            query = query.Where(v => v.VendorStatus != (int)Vendor.StatusEnum.Deleted);
            query = query.OrderBy(v => v.UpdatedOnUtc).ThenBy(v => v.VendorName);

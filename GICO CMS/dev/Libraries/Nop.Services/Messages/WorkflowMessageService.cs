...
namespace Nop.Services.Messages
{
    ...
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        public virtual int SendCustomerRegisteredNotificationMessage(Customer customer, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.CustomerRegisteredNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendCustomerWelcomeMessage(Customer customer, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.CustomerWelcomeMessage, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendCustomerEmailValidationMessage(Customer customer, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.CustomerEmailValidationMessage, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendCustomerEmailRevalidationMessage(Customer customer, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.CustomerEmailRevalidationMessage, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendCustomerPasswordRecoveryMessage(Customer customer, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.CustomerPasswordRecoveryMessage, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendOrderPlacedVendorNotification(Order order, Vendor vendor, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderPlacedVendorNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendOrderPlacedStoreOwnerNotification(Order order, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderPlacedStoreOwnerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendOrderPaidStoreOwnerNotification(Order order, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderPaidStoreOwnerNotification, 0);
            if (messageTemplate == null)
                return 0;
            ...
            string attachmentFilePath = null, string attachmentFileName = null)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderPaidCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendOrderPaidVendorNotification(Order order, Vendor vendor, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderPaidVendorNotification, 0);
            if (messageTemplate == null)
                return 0;
            ...
            string attachmentFilePath = null, string attachmentFileName = null)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderPlacedCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendShipmentSentCustomerNotification(Shipment shipment, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.ShipmentSentCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendShipmentDeliveredCustomerNotification(Shipment shipment, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.ShipmentDeliveredCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
            ...
            string attachmentFilePath = null, string attachmentFileName = null)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderCompletedCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendOrderCancelledCustomerNotification(Order order, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderCancelledCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendOrderRefundedStoreOwnerNotification(Order order, decimal refundedAmount, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderRefundedStoreOwnerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendOrderRefundedCustomerNotification(Order order, decimal refundedAmount, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OrderRefundedCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendNewOrderNoteAddedCustomerNotification(OrderNote orderNote, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewOrderNoteAddedCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendRecurringPaymentCancelledStoreOwnerNotification(RecurringPayment recurringPayment, int languageId)
        {
            ...
            var store = _storeService.GetStoreById(recurringPayment.InitialOrder.StoreId);
            languageId = EnsureLanguageIsActive(languageId, 0);

            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.RecurringPaymentCancelledStoreOwnerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendRecurringPaymentCancelledCustomerNotification(RecurringPayment recurringPayment, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.RecurringPaymentCancelledCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendRecurringPaymentFailedCustomerNotification(RecurringPayment recurringPayment, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.RecurringPaymentFailedCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendNewsLetterSubscriptionActivationMessage(NewsLetterSubscription subscription, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewsletterSubscriptionActivationMessage, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendNewsLetterSubscriptionDeactivationMessage(NewsLetterSubscription subscription, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewsletterSubscriptionDeactivationMessage, 0);
            if (messageTemplate == null)
                return 0;
            ...
            Product product, string customerEmail, string friendsEmail, string personalMessage)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.EmailAFriendMessage, 0);
            if (messageTemplate == null)
                return 0;
             ...
             string customerEmail, string friendsEmail, string personalMessage)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.WishlistToFriendMessage, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendNewReturnRequestStoreOwnerNotification(ReturnRequest returnRequest, OrderItem orderItem, int languageId)
        {
            ...
            var store = _storeService.GetStoreById(orderItem.Order.StoreId);
            languageId = EnsureLanguageIsActive(languageId, 0);

            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewReturnRequestStoreOwnerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendNewReturnRequestCustomerNotification(ReturnRequest returnRequest, OrderItem orderItem, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewReturnRequestCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendReturnRequestStatusChangedCustomerNotification(ReturnRequest returnRequest, OrderItem orderItem, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.ReturnRequestStatusChangedCustomerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public int SendNewForumTopicMessage(Customer customer, ForumTopic forumTopic, Forum forum, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewForumTopicMessage, 0);
            if (messageTemplate == null)
                return 0;
            ...
            Forum forum, int friendlyForumTopicPageIndex, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewForumPostMessage, 0);
            if (messageTemplate == null )
                return 0;
        ...
        public int SendPrivateMessageNotification(PrivateMessage privateMessage, int languageId)
        {
            ...
            var store = _storeService.GetStoreById(privateMessage.StoreId);

            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.PrivateMessageNotification, 0);
            if (messageTemplate == null )
                return 0;
        ...
        public virtual int SendNewVendorAccountApplyStoreOwnerNotification(Customer customer, Vendor vendor, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewVendorAccountApplyStoreOwnerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendVendorInformationChangeNotification(Vendor vendor, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.VendorInformationChangeNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendGiftCardNotification(GiftCard giftCard, int languageId)
        {
            ...
            var store = order != null ? _storeService.GetStoreById(order.StoreId) : null;

            languageId = EnsureLanguageIsActive(languageId, 0);

            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.GiftCardNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendProductReviewNotificationMessage(ProductReview productReview, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.ProductReviewNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendQuantityBelowStoreOwnerNotification(Product product,  int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.QuantityBelowStoreOwnerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendQuantityBelowStoreOwnerNotification(ProductAttributeCombination combination, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.QuantityBelowAttributeCombinationStoreOwnerNotification, 0);
            if (messageTemplate == null)
                return 0;
            ...
            string vatName, string vatAddress, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewVatSubmittedStoreOwnerNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendBlogCommentNotificationMessage(BlogComment blogComment, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.BlogCommentNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendNewsCommentNotificationMessage(NewsComment newsComment, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.NewsCommentNotification, 0);
            if (messageTemplate == null)
                return 0;
        ...
        public virtual int SendBackInStockNotification(BackInStockSubscription subscription, int languageId)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.BackInStockNotification, 0);
            if (messageTemplate == null)
                return 0;
            ...
            string senderName, string subject, string body)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.ContactUsMessage, 0);
            if (messageTemplate == null)
                return 0;
            ...
            string senderName, string subject, string body)
        {
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.ContactVendorMessage, 0);
            if (messageTemplate == null)
                return 0;

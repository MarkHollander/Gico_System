    ...
    public partial class SitemapGenerator : ISitemapGenerator
    {
        ...
        protected virtual IList<SitemapUrl> GenerateUrls()
        {
            ...
            if (_commonSettings.SitemapIncludeCategories)
                sitemapUrls.AddRange(GetCategoryUrls(string.Empty));
        ...
        protected virtual IEnumerable<SitemapUrl> GetCategoryUrls(string parentCategoryId)
        {
            var urlHelper = GetUrlHelper();
            return _categoryService.GetAllCategoriesByParentCategoryId(parentCategoryId).SelectMany(category =>
            {
                ...
                sitemapUrls.AddRange(GetCategoryUrls(category.CategoryId));
        ...
        {
            var urlHelper = GetUrlHelper();
            return _manufacturerService.GetAllManufacturers(storeId: 0).Select(manufacturer =>
            {
        ...
        {
            var urlHelper = GetUrlHelper();
            return _productService.SearchProducts(storeId: 0,
        ...
        {
            var urlHelper = GetUrlHelper();
            return _topicService.GetAllTopics(0).Where(t => t.IncludeInSitemap).Select(topic =>
            {

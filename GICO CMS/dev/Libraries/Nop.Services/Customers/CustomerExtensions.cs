...
namespace Nop.Services.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static bool PasswordIsExpired(this Customer customer)
        {
            ...
            var cacheKey = string.Format(CustomerCacheEventConsumer.CUSTOMER_PASSWORD_LIFETIME, customer.CustomerId);

            //get current password usage time
            //var currentLifetime = cacheManager.Get(cacheKey, () =>
            //{
            //    //var customerPassword = EngineContext.Current.Resolve<ICustomerService>().GetCurrentPassword(customer.CustomerId);

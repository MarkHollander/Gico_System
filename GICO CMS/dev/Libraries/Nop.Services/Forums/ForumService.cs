...
namespace Nop.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        public virtual IPagedList<ForumPost> GetAllPosts(int forumTopicId = 0, string customerId = "",
        ...
        public virtual IPagedList<PrivateMessage> GetAllPrivateMessages(int storeId, string fromCustomerId,
        ...
        public virtual IPagedList<ForumSubscription> GetAllSubscriptions(string customerId = "", int forumId = 0,
            int topicId = 0, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            var fsQuery = from fs in _forumSubscriptionRepository.Table
                          join c in _customerRepository.Table on fs.CustomerId equals c.CustomerId
                          where
        ...
        public virtual bool IsCustomerAllowedToEditTopic(Customer customer, ForumTopic topic)
        {
            ...
            {
                var ownTopic = customer.CustomerId == topic.CustomerId;
                return ownTopic;
            }
        ...
        public virtual bool IsCustomerAllowedToEditPost(Customer customer, ForumPost post)
        {
            ...
            if (_forumSettings.AllowCustomersToEditPosts)
            {
                var ownPost = customer.CustomerId == post.CustomerId;
                return ownPost;
            }
        ...
        public virtual ForumPostVote GetPostVote(int postId, Customer customer)
        {
            ...
            return _forumPostVoteRepository.Table.FirstOrDefault(pv => pv.ForumPostId == postId && pv.CustomerId == customer.CustomerId);
        }
        ...
        public virtual int GetNumberOfPostVotes(Customer customer, DateTime сreatedFromUtc)
        {
            ...
            return _forumPostVoteRepository.Table.Count(pv => pv.CustomerId == customer.Code && pv.CreatedOnUtc > сreatedFromUtc);
        }

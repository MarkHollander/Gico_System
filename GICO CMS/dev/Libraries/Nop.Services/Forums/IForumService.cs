...
namespace Nop.Services.Forums
{
    ...
    public partial interface IForumService
    {
        ...
        IPagedList<ForumPost> GetAllPosts(int forumTopicId = 0, string customerId = "",
        ...
        IPagedList<PrivateMessage> GetAllPrivateMessages(int storeId, string fromCustomerId,
        ...
        IPagedList<ForumSubscription> GetAllSubscriptions(string customerId, int forumId = 0,

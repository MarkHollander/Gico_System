...
namespace Nop.Services.Events
{
    ...
    public class EventPublisher : IEventPublisher
    {
        ...
        private IEventNotifyService _eventNotifyService;

        /// <summary>
        /// Ctor
        /// </summary>
        /// <param name="subscriptionService"></param>
        public EventPublisher(ISubscriptionService subscriptionService, IEventNotifyService eventNotifyService)
        {
        ...
        public virtual void Publish<T>(T eventMessage)
        {
            ...
            _eventNotifyService.Notify(eventMessage);
        }
    }
}

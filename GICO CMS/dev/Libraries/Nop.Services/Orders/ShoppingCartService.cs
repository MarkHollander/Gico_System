...
//            //Store mapping
//            if (!_storeMappingService.Authorize(product, 0))
//            {
//                warnings.Add(_localizationService.GetResource("ShoppingCart.ProductUnpublished"));
//            }
...
//                            shoppingCartType, associatedProduct, 0,
...
//                var attributes2 = _checkoutAttributeService.GetAllCheckoutAttributes(0, excludeShippableAttributes);
...
//            var checkoutAttributesXml = fromCustomer.GetAttribute<string>(SystemCustomerAttributeNames.CheckoutAttributes, _genericAttributeService, 0);
//            _genericAttributeService.SaveAttribute(toCustomer, SystemCustomerAttributeNames.CheckoutAttributes, checkoutAttributesXml, 0);
//        }

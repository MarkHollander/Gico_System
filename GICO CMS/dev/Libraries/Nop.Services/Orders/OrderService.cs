...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        public virtual IPagedList<Order> SearchOrders(int storeId = 0,
            int vendorId = 0, string customerId = "",
        ...
        public virtual IList<OrderItem> GetDownloadableOrderItems(string customerId)
        {
            if (string.IsNullOrEmpty(customerId))
        ...
        public virtual IPagedList<RecurringPayment> SearchRecurringPayments(int storeId = 0,
            string customerId = "", int initialOrderId = 0, OrderStatus? initialOrderStatus = null,
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            ...
            var query1 = from rp in _recurringPaymentRepository.Table
                join c in _customerRepository.Table on rp.InitialOrder.CustomerId equals c.CustomerId
                where
                (!rp.Deleted) &&

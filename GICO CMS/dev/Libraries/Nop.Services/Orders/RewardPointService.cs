...
namespace Nop.Services.Orders
{
    ...
    public partial class RewardPointService : IRewardPointService
    {
        ...
        public virtual IPagedList<RewardPointsHistory> GetRewardPointsHistory(string customerId = "", bool showHidden = false,
            ...
            Order usedWithOrder = null, decimal usedAmount = 0M, DateTime? activatingDate = null)
        {
            ...
            var rph = new RewardPointsHistory
            {
                ...
                Points = points,
                PointsBalance = activatingDate.HasValue ? null : (int?)(GetRewardPointsBalance(customer.CustomerId, storeId) + points),
        ...
        public virtual int GetRewardPointsBalance(string customerId, int storeId)
        {
            var query = _rphRepository.Table;
            if (!string.IsNullOrEmpty(customerId))
                query = query.Where(rph => rph.CustomerId == customerId);

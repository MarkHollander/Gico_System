...
//                //    _rewardPointService.AddRewardPointsHistoryEntry(customer, -rewardPointsOfOrder.Points - rewardPoints, 0, "Return unused reward points");
...
//                                    updatedOrder.ShippingRateComputationMethodSystemName, 0);
...
//                            var shippingOptionsResponse = _shippingService.GetShippingOptions(restoredCart, updatedOrder.ShippingAddress, updatedOrder.Customer, updatedOrder.ShippingRateComputationMethodSystemName, 0);
...
//                            var pickupPointsResponse = _shippingService.GetPickupPoints(updatedOrder.BillingAddress, _workContext.CurrentCustomer, storeId: 0);
//                            if (pickupPointsResponse.Success)
//                            {
...
//                                _shippingService.LoadActiveShippingRateComputationMethods(_workContext.CurrentCustomer, 0);
//                            if (shippingRateComputationMethods.Any())
//                            {
//                                var shippingOptionsResponse = _shippingService.GetShippingOptions(restoredCart, customer.ShippingAddress, _workContext.CurrentCustomer, storeId: 0);
//                                if (shippingOptionsResponse.Success)
//                                {
...
//                useRewardPoints = customer.GetAttribute<bool>(SystemCustomerAttributeNames.UseRewardPointsDuringCheckout, _genericAttributeService, 0);

//            if (!useRewardPoints.Value)
//                return;

//            var rewardPointsBalance = _rewardPointService.GetRewardPointsBalance(customer.Id, 0);
...
//            if (customer != null)
//            {
//                var checkoutAttributesXml = customer.GetAttribute<string>(SystemCustomerAttributeNames.CheckoutAttributes, _genericAttributeService, 0);
...
//            if (customer != null)
//                shippingOption = customer.GetAttribute<ShippingOption>(SystemCustomerAttributeNames.SelectedShippingOption, _genericAttributeService, 0);
...
//                var shippingRateComputationMethods = _shippingService.LoadActiveShippingRateComputationMethods(_workContext.CurrentCustomer, 0);

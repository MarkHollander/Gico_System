...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        protected virtual IPagedList<Product> SearchProductsUseLinq(ref IList<int> filterableSpecificationAttributeOptionIds,
            bool loadFilterableSpecificationAttributeOptionIds, int pageIndex, int pageSize, IList<string> categoryIds,
        ...
        public virtual int GetNumberOfProductsInCategory(IList<string> categoryIds = null, int storeId = 0)
        {
            //validate "categoryIds" parameter
            if (categoryIds != null && categoryIds.Contains(string.Empty))
                categoryIds.Remove(string.Empty);

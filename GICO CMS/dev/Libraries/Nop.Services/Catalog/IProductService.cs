...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        int GetNumberOfProductsInCategory(IList<string> categoryIds = null, int storeId = 0);
        ...
        IPagedList<ProductReview> GetAllProductReviews(string customerId, bool? approved,

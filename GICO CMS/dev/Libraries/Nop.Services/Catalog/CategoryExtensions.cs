...
namespace Nop.Services.Catalog
{
    ...
    public static class CategoryExtensions
    {
        ...
        public static IList<Category> SortCategoriesForTree(this IList<Category> source, string parentId = "", bool ignoreCategoriesWithoutExistingParent = false)
        {
            ...
            {
                result.Add(cat);
                result.AddRange(SortCategoriesForTree(source, cat.CategoryId, true));
            }
        ...
        public static ProductCategory FindProductCategory(this IList<ProductCategory> source,
            int productId, string categoryId)
        {
            ...
            string separator = ">>", int languageId = 0)
        {
            ...
            {
                var categoryName = breadcrumb[i].GetLocalized(x => x.CategoryName, languageId);
            ...
            bool showHidden = false)
        {
            ...
            while (category != null && //not null
                !(category.CategoryStatus == -1) && //not deleted
                (showHidden || category.CategoryStatus == 1) && //published
